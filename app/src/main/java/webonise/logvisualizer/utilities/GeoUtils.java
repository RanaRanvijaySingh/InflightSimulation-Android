...
/*
 * A collection of static utility methods for geo arithmetic
 * not natively provided by the Maps API.
 */
public class GeoUtils {
    ...
    // method to get initial map location for the app
    public static LatLng getMapBackdrop() {
        LatLng loc = new LatLng(48.19465077160729, 12.848961353302002);
        return loc;
    }
    ...
    public static double getAreaInAcres(List<LatLng> poly) {
        double sqMeters = calculatePolygonAreaSquareMeters(poly);
        double acres = ConversionUtils.squareMetersToAcres(sqMeters);
        return acres;
    }
